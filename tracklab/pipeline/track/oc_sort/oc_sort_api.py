"""OC-SORT multi-object tracking module for TrackLab."""
...
class OCSORT(ImageLevelModule):
    ...
    This module performs multi-object tracking using the OC-SORT algorithm,
    which uses observation-centric tracking for improved performance.
    """
