"""ByteTrack multi-object tracking module for TrackLab."""
...
class ByteTrack(ImageLevelModule):
    ...
    This module performs multi-object tracking using the ByteTrack algorithm,
    which improves tracking by associating low-confidence detections.
    """
    ...
    def __init__(self, cfg: Any, device: str, **kwargs: Any) -> None:
        """Initialize the ByteTrack module.
    ...
    def preprocess(
        ...
        Args:
            image: Input image array (unused for tracking).
