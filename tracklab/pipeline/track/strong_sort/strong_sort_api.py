"""StrongSORT multi-object tracking module for TrackLab."""
...
class StrongSORT(ImageLevelModule):
    ...
    This module performs multi-object tracking using the StrongSORT algorithm,
    which combines motion and appearance cues with camera motion compensation.
    """
    ...
    def __init__(self, cfg: Any, device: str, **kwargs: Any) -> None:
        """Initialize the StrongSORT module.
    ...
    def process(
        ...
        """Process batch and perform tracking with camera motion compensation.
