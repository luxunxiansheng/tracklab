...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s",
        "--soccernet",
        default="/home/fmg/data/SN23/calibration-2023-bis/",
        type=str,
    ...
    parser.add_argument(
        "-p",
        "--prediction",
        default="/home/fmg/results/SN23-tests/",
        required=False,
        type=str,
    ...
    with tqdm(
        enumerate(match_info.keys()), total=len(match_info.keys()), ncols=160
    ) as t:
        for i, match in t:
                        ...
                        if success:
                            ...
                            for k, potential_matches in potential_3d_2d_matches.items():
                                ...
                                if (
                                    ...
                                    for i, potential_match in enumerate(
                                        potential_matches
                                    ):
                                        dist[i] = np.sqrt(
