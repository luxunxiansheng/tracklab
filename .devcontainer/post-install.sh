...
python -c "from tracklab.pipeline.jersey.mmocr_api import MMOCR; from tracklab.pipeline.reid.prtreid import PRTReId; print('✅ All TrackLab imports successful!')" 2>/dev/null || {
